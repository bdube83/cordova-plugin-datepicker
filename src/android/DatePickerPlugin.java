/**
 * @author Bongani Dube (https://github.com/bdube83)
 * Added material design theme for android app.
 *
	...
	private Runnable runnableDatePicker(
		...
		return new Runnable() {
			...
			public void run() {
				...
				dateDialog.show(cordova.getActivity().getFragmentManager(), "Datepickerdialog");
			}
		};
	}
